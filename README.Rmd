...
4.  'scree_plot' visualising the additional proportion of variance exaplained (PVE) in the test data for higher order polynomial models. This is calculated as follows:
...
It is recommended that the order of the model be select as that to the left of the 'elbow' (where the improvement plateaus). For example, this would be three in the below (output from this function)
